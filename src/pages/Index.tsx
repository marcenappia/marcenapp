...
const Index = () => {
  ...
  return (
    <div className="flex h-screen bg-background font-sans overflow-hidden">
      ...
      <IaraAssistantLayer
        open={showIara}
        onOpenChange={setShowIara}
        project={budgetProject}
        contextLabel={iaraContextLabel}
        onProjectChange={(p) => setBudgetProject(prev => ({ ...prev, ...p }))}
      />
