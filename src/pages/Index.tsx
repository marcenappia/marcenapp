  ...
  return (
    <div className="flex h-screen bg-background font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-slate-50 h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-8 pb-24 md:pb-8 scroll-smooth"><div className="max-w-7xl mx-auto">{renderModule()}</div></div>
