...
import ProfessionalProfilesAdmin from './ProfessionalProfiles';
...
export default function CreditRules() {
  ...
  return <section className="space-y-6">
    <div><h2 className="text-xl font-bold text-slate-800">Administração e observabilidade</h2><p className="text-sm text-slate-500">O painel observa créditos, perfis profissionais, Skills, execuções da IARA, alertas operacionais e o provedor de IA usado pelo ambiente.</p></div>

    <ProfessionalProfilesAdmin />
