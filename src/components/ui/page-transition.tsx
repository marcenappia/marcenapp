...
const variants = {
  ...
  'slide-right': { initial: { opacity: 0, x: -40 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: 40 } },
  zoom: { initial: { opacity: 0, scale: 0.94 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 1.04 } },
};

const PageTransition = ({ children, effect = 'fade', duration = 0.3, className = '' }: PageTransitionProps) => {
