...
import { Button, Card, Modal, InputGroup, SelectGroup } from './shared';
...
const ModuleOrcamento = ({ project, setProject }: Props) => {
  ...
  const calc = useMemo(() => {
    ...
    const intMat = prices[project.internalMaterial as keyof typeof prices] as { price: number; area: number };
    const extMat = prices[project.externalMaterial as keyof typeof prices] as { price: number; area: number };
...
export default ModuleOrcamento;
