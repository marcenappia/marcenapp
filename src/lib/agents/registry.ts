...
export const agents: AgentDefinition[] = [
  ...
  createSpatialAgent('furniture_engineering', 'Agente de Engenharia do Móvel', ['furniture.engineer', 'furniture.clearances.validate', 'furniture.hardware.validate'], ['multiview']),
  ...
  createSpatialAgent('render', 'Agente de Render Técnico', ['render.scene.prepare', 'render.generate', 'render.from.validated.package'], ['multiview', 'furniture_engineering', 'materials']),
