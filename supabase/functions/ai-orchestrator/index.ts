...
const TOOL_DECLARATIONS = [
  ...
  { name: "gerarRender", description: "Gera uma visualização do móvel somente quando houver contexto visual disponível, como uma referência enviada ou um ambiente do projeto com imagem. Sem referência visual, não chame esta ferramenta; peça uma imagem primeiro.", parameters: { type: "object", properties: { prompt: { type: "string" }, estilo: { type: "string" } }, required: ["prompt"] } },
...
- A IARA pode interpretar pedidos por texto sem imagem, mas cada ferramenta mantém seus próprios requisitos de entrada.
